...
class ClassDetailsCard extends StatefulWidget {
  ...
  final RxList<StudentModel> studentsInClass;
                          ...
                          _buildInfoSection(
                            ...
                            children: [
                              ...
                              Obx(
                                () => _buildInfoRow(
                                  'Total Students',
                                  widget.classData.studentCount.value
                                      .toString(),
                                ),
                              ),
                            ],
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.people, color: theme.colorScheme.primary, size: 20.sp),
              SizedBox(width: 12.w),
              Text(
                'Students in Class',
                style: theme.textTheme.titleLarge?.copyWith(
          ...
          SizedBox(height: 16.h),
          Obx(() {
            final students = widget.studentsInClass;
            if (students.isEmpty) {
              return Center(
                child: Padding(
                  padding: EdgeInsets.all(32.w),
